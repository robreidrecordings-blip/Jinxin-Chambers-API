...
const stores = {
  com: {
   ...
   consumerSecret: process.env.WC_COM_CONSUMER_SECRET,cs_0757cba26afe2fb757091c045caedaae8f25df11
  },
  co_uk: {
   ...
   consumerSecret: process.env.WC_CO_UK_CONSUMER_SECRET,cs_fe9a5a726282fec835a146c0da8fc1256e14abc4
  },
  net: {
   ...
   consumerSecret: process.env.WC_NET_CONSUMER_SECRET,cs_1c2deeaf9a861137f438564051077dd27539ae61
  }
};
